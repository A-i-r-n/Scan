//
//  AirScanningCodeViewController.m
//  Scan
//
...
#import "AirScanningCodeView.h"
@interface AirScanningCodeViewController ()<AVCaptureMetadataOutputObjectsDelegate, UINavigationControllerDelegate, UIImagePickerControllerDelegate>
/** 会话对象 */
@property (nonatomic, strong) AVCaptureSession *session;
/** 图层类 */
@property (nonatomic, strong) AVCaptureVideoPreviewLayer *previewLayer;
@property (nonatomic, strong) AirScanningCodeView *scanningView;
...
@implementation AirScanningCodeViewController
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    // 创建扫描边框
    self.scanningView = [[AirScanningCodeView alloc] initWithFrame:self.view.frame outsideViewLayer:self.view.layer];
